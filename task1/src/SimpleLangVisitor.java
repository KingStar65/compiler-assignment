...
public interface SimpleLangVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SimpleLangParser#mainFunc}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMainFunc(SimpleLangParser.MainFuncContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitVarDeclExpr(SimpleLangParser.VarDeclExprContext ctx);
	/**
